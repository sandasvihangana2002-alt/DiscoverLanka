...
type Destination = { slug: string; name: string; region: string; summary: string; image: string };
...
export default function PlanPage() {
  ...
  useEffect(() => {
    try {
      ...
      if (Array.isArray(savedPlaces)) { setSaved(savedPlaces); setSelected(savedPlaces); }
    } catch {}
  ...
  const suggested = useMemo(() => {
    const order = interest === "Coast" ? ["galle", "mirissa", "ella", "kandy"] : interest === "Wildlife" ? ["yala", "ella", "kandy", "mirissa"] : interest === "Culture" ? ["sigiriya", "kandy", "galle", "ella"] : interest === "Food" ? ["kandy", "galle", "mirissa", "ella"] : interest === "Slow travel" ? ["ella", "galle", "mirissa", "kandy"] : ["ella", "kandy", "sigiriya", "yala"];
