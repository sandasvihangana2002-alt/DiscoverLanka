...
type Results = { destinations: Destination[]; stories: Story[] };
const empty: Results = { destinations: [], stories: [] };
...
export default function SearchPage() {
  ...
  async function runSearch(value: string) {
    ...
    try {
      ...
      setResults({ destinations: data.destinations ?? [], stories: data.stories ?? [] });
